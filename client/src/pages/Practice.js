...
import MyButtonList from "../components/PracticeButtonList";
import ModelButtonList from "../components/PracticeModelButtonList";
    ...
    */
    ...
    const detectHands = () => {
      ...
      if(videoRef.current && videoRef.current.readyState >= 2){
        ...
        //console.log("in practiceModelInd" + modelIndex);
